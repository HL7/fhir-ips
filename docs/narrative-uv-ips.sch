...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile Narrative
  ...
  -->
  <sch:pattern>
    <sch:title>Narrative</sch:title>
    <sch:rule context="f:Narrative">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Narrative.div</sch:title>
    <sch:rule context="f:Narrative/f:div">
