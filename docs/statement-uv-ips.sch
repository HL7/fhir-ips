...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'statementNote']) &lt;= 1">extension with URL = 'statementNote': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>Extension.extension.valueReference</sch:title>
    <sch:rule context="f:Extension/f:extension/f:valueReference">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Extension.extension.valueString</sch:title>
    <sch:rule context="f:Extension/f:extension/f:valueString">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
