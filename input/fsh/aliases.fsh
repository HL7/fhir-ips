...
Alias: $medication-statement-status-vs = http://hl7.org/fhir/ValueSet/medication-statement-status
Alias: $medicationrequest-status = http://hl7.org/fhir/CodeSystem/medicationrequest-status
Alias: $medicationrequest-status-vs = http://hl7.org/fhir/ValueSet/medicationrequest-status
Alias: $allergyintolerance-verification-vs = http://hl7.org/fhir/ValueSet/allergyintolerance-verification
