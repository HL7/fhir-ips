...
* section.text 1.. MS
* section.text ^extension[0].url = "http://hl7.org/fhir/StructureDefinition/structuredefinition-explicit-type-name"
* section.text ^extension[=].valueString = "Section"
...
* section[sectionMedications].title ^extension[0].url = "http://hl7.org/fhir/StructureDefinition/obligation"
...
* section[sectionImmunizations].title ^extension[0].url = "http://hl7.org/fhir/StructureDefinition/obligation"
...
* section[sectionResults].title ^extension[0].url = "http://hl7.org/fhir/StructureDefinition/obligation"
...
* section[sectionProceduresHx].title ^extension[0].url = "http://hl7.org/fhir/StructureDefinition/obligation"
...
* section[sectionMedicalDevices].title ^extension[0].url = "http://hl7.org/fhir/StructureDefinition/obligation"
