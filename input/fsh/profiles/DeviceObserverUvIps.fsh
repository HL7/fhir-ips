...
* manufacturer ^extension[=].extension[=].valueCanonical = "http://hl7.org/fhir/uv/ips/ActorDefinition/IPS-Producer"
...
* manufacturer ^extension[=].extension[+].url = "actor"
* manufacturer ^extension[=].extension[=].valueCanonical = "http://hl7.org/fhir/uv/ips/ActorDefinition/IPS-Consumer"
* manufacturer ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* manufacturer ^extension[=].extension[0].url = "code"
...
* modelNumber ^extension[=].extension[=].valueCanonical = "http://hl7.org/fhir/uv/ips/ActorDefinition/IPS-Producer"
...
* modelNumber ^extension[=].extension[+].url = "actor"
* modelNumber ^extension[=].extension[=].valueCanonical = "http://hl7.org/fhir/uv/ips/ActorDefinition/IPS-Consumer"
* modelNumber ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* modelNumber ^extension[=].extension[0].url = "code"
