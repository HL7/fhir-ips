...
* result MS
* result ^extension[0].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* result ^extension[=].extension[0].url = "code"
* result ^extension[=].extension[=].valueCode = #SHALL:populate-if-known
* result ^extension[=].extension[+].url = "actor"
* result ^extension[=].extension[=].valueCanonical = "http://hl7.org/fhir/uv/ips/ActorDefinition/producer"
* result ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* result ^extension[=].extension[0].url = "code"
* result ^extension[=].extension[=].valueCode = #SHALL:handle
* result ^extension[=].extension[+].url = "actor"
* result ^extension[=].extension[=].valueCanonical = "http://hl7.org/fhir/uv/ips/ActorDefinition/consumer"
* result ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* result ^extension[=].extension[0].url = "code"
* result ^extension[=].extension[=].valueCode = #SHOULD:display
* result ^extension[=].extension[+].url = "actor"
* result ^extension[=].extension[=].valueCanonical = "http://hl7.org/fhir/uv/ips/ActorDefinition/consumer"
...
* result[observation-results] ^extension[=].extension[=].valueCanonical = "http://hl7.org/fhir/uv/ips/ActorDefinition/producer"
...
* result[observation-results] ^extension[=].extension[+].url = "actor"
* result[observation-results] ^extension[=].extension[=].valueCanonical = "http://hl7.org/fhir/uv/ips/ActorDefinition/consumer"
* result[observation-results] ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* result[observation-results] ^extension[=].extension[0].url = "code"
