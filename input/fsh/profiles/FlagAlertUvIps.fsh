...
* extension[flag-priority] ^extension[=].extension[=].valueCanonical = "http://hl7.org/fhir/uv/ips/ActorDefinition/IPS-Producer"
...
* extension[flag-priority] ^extension[=].extension[+].url = "actor"
* extension[flag-priority] ^extension[=].extension[=].valueCanonical = "http://hl7.org/fhir/uv/ips/ActorDefinition/IPS-Consumer"
* extension[flag-priority] ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* extension[flag-priority] ^extension[=].extension[0].url = "code"
