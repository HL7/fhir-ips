...
* valueDateTime ^extension[=].extension[=].valueCanonical = "http://hl7.org/fhir/uv/ips/ActorDefinition/IPS-Producer"
...
* valueDateTime ^extension[=].extension[+].url = "actor"
* valueDateTime ^extension[=].extension[=].valueCanonical = "http://hl7.org/fhir/uv/ips/ActorDefinition/IPS-Consumer"
* valueDateTime ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* valueDateTime ^extension[=].extension[0].url = "code"
