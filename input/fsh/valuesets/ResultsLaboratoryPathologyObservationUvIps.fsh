...
* include codes from system $loinc where STATUS = "ACTIVE" and CLASSTYPE = "1" // "Laboratory class"
* exclude codes from system $loinc where CLASS = "LP62148-9" // NR STATS
* exclude codes from system $loinc where CLASS = "LP175679-2" // H&P.HX.LAB
* exclude codes from system $loinc where CLASS = "LP7785-1" // CHALSKIN
* exclude codes from system $loinc where CLASS = "LP94892-4" // LABORDERS