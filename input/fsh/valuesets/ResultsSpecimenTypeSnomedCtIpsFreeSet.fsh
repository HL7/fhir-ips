...
Id: results-specimen-type-snomed-ct-ips-free-set
Title: "Results Specimen Type - SNOMED CT IPS Free Set"
Description: "This value set includes the codes from the SNOMED International Patient Set (IPS) subset of SNOMED CT (IPS Free Set) that are included in: all descendants of 123038009 \\|Specimen (specimen)\\|."
* ^version = "1.1.0"
* ^status = #active
* ^experimental = false
* ^date = "2022-08-20T13:24:58+00:00"
...
* ^expansion.timestamp = "2022-08-20T13:24:58+00:00"
* ^expansion.total = 127
* ^expansion.offset = 0
...
* ^expansion.contains[=].display = "Blood specimen submitted in heparinized collection tube"
* ^expansion.contains[+].system = "http://snomed.info/sct"
...
* ^expansion.contains[=].display = "Esophageal brushings specimen"
* ^expansion.contains[+].system = "http://snomed.info/sct"
...
* ^expansion.contains[=].display = "Respiratory specimen"
* ^expansion.contains[+].system = "http://snomed.info/sct"
...
* ^expansion.contains[=].display = "Vitreous humor specimen"
* ^expansion.contains[+].system = "http://snomed.info/sct"
* ^expansion.contains[=].code = #258435002
* ^expansion.contains[=].display = "Tumor tissue specimen"
* ^expansion.contains[+].system = "http://snomed.info/sct"
...
* ^expansion.contains[+].system = "http://snomed.info/sct"
* ^expansion.contains[=].code = #119360007
* ^expansion.contains[=].display = "Dialysis fluid specimen"
* ^expansion.contains[+].system = "http://snomed.info/sct"
