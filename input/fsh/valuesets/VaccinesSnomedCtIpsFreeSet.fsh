...
Id: vaccines-snomed-ct-ips-free-set
Title: "Vaccines - SNOMED CT IPS Free Set"
Description: "This value set includes the codes from the SNOMED International Patient Set (IPS) subset of SNOMED CT (IPS Free Set) that are included in: all descendants of 71181003 \\|Product containing vaccine (product)\\|."
* ^version = "1.1.0"
* ^status = #active
* ^experimental = false
* ^date = "2022-09-07T11:24:30+00:00"
...
* ^expansion.timestamp = "2022-09-07T11:24:30+00:00"
* ^expansion.total = 78
* ^expansion.offset = 0
...
* include codes from system http://snomed.info/sct
    where constraint = "< 787859002 |Vaccine product (medicinal product)| AND ^ 816080008 |International Patient Summary (foundation metadata concept)|"