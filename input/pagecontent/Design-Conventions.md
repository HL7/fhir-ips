...
Additional perspective on the alignment of IPS to broader guidance around clinical documents in FHIR are included in the [Alignment to FHIR Clinical Documents](./About.html#alignment-to-fhir-clinical-documents) section. 
...
This specification requires that any Person Name is represented including at least one of the following components: given, family or text. Although it is recognized that there is not the concept of "family name" in all cultures, when the name of a person is provided it SHOULD be provided as a list of parts, such as given, family, prefix and suffix. 
