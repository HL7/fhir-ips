...
Granular requirements regarding what is considered clinically relevant for inclusion in the narrative of each section are not currently defined in [ISO 27269](https://www.iso.org/standard/79491.html) and subsequently not defined or enforced in this guide. While a globally consistent practice has not been identified, IPS encourages implementers to review emerging best practices and guidelines regarding narrative text that being [implemented in participating nations](https://informatiestandaarden.nictiz.nl/wiki/FHIR:V1.0_FHIR_IG_STU3#Resource.text_or_.22the_narrative.22) and discussed in the  [FHIR Community](https://chat.fhir.org/#narrow/stream/207835-IPS/topic/generation.20of.20narrative).
