...
Alignments of IPS to other FHIR guides are discussed in the [Dependencies and Related Guides](./About.html#dependencies-and-related-guides). Further details on the IPS project relationships with other projects and guidelines are available in the <a href="https://international-patient-summary.net/">IPS Website</a>.
